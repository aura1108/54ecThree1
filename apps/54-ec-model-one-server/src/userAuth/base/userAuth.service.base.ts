...
export class UserAuthServiceBase {
  ...
  async getUserDetails(parentId: string): Promise<PrismaUserDetail | null> {
    return this.prisma.userAuth
      .findUnique({
        where: { id: parentId },
      })
      .userDetails();
  ...
  async getUserDocument(parentId: string): Promise<PrismaUserDocument | null> {
    return this.prisma.userAuth
      .findUnique({
        where: { id: parentId },
      })
